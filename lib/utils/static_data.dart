...
/// List of pre-filled books for library from my bookshelf.
List<Book> bookShelf = [
  Book(
      id: '',
      ...
      title: 'Shoe Dog',
      author: 'Phil Knight',
      date: DateTime.parse('2018-05-03'),
      genre: 'Adventure',
      description:
          'In 1962, fresh out of business school, Phil Knight borrowed \$50 from his father and created a company with a simple mission: import high-quality,'
          ' low-cost athletic shoes from Japan. Selling the shoes from the boot of his Plymouth, Knight grossed \$8000 in his first year.'
          ' Today, Nike\'s annual sales top \$30 billion. In an age of start-ups, Nike is the ne plus ultra of all start-ups, and the swoosh '
          'has become a revolutionary, globe-spanning icon, one of the most ubiquitous and recognisable symbols in the world today.'
          '\n\nBut Knight, the man behind the swoosh, has always remained a mystery. Now, for the first time, he tells his story. Candid, humble, wry and gutsy, '
          'he begins with his crossroads moment when at 24 he decided to start his own business. He details the many risks and daunting '
          'setbacks that stood between him and his dream - along with his early triumphs. Above all, he recalls how his first band of '
          'partners and employees soon became a tight-knit band of brothers. Together, harnessing the transcendent power of a shared mission'
          ', and a deep belief in the spirit of sport, they built a brand that changed everything.'
          '\n\nA memoir rich with insight, humour and hard-won wisdom, this book is also studded with lessons - about building something from scratch,'
          ' overcoming adversity, and ultimately leaving your mark on the world.'),
  Book(
      id: '',
      createdAt: Timestamp.now(),
      title: 'Life 3.0: Being Human in the Age of Artificial Intelligence',
      author: 'Max Tegmark',
      date: DateTime.parse('2017-08-23'),
      genre: 'Science',
      description:
  ...
  Book(
      ...
      date: DateTime.parse('2019-09-17'),
      genre: 'Drama',
      description:
  ...
  Book(
      ...
      genre: 'History',
      description:
          'Start-Up Nation addresses the trillion dollar question: How is it that Israel -- a country of 7.1 million, only 60 years old, '
  ...
  Book(
      id: '',
      createdAt: Timestamp.now(),
      title: 'Insight Out: Get Ideas Out of Your Head and Into the World',
      author: 'Tina Seelig',
      date: DateTime.parse('2007-04-24'),
      genre: 'Technical',
      description:
          'In this revolutionary guide, Stanford University Professor and international bestselling author of inGenius adopts '
  ...
  Book(
      ...
      date: DateTime.parse('2015-04-30'),
      genre: 'History',
      description:
          'What makes us brilliant? What makes us deadly? What makes us Sapiens? Yuval Noah Harari challenges everything we know about '
